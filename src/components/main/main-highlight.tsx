...
const apiTest = (): AxiosPromise => {
  return apiMmsClient.get("/hiTest");
};
...
const MainHighlight = () => {
  ...
  return (
    <HighlightWrap>
              ...
              <HighlightContent>
                  ...
                  <HighlightPagination>
                      ...
                      <Box className={'page-number'}>
                          <Typography className={'page-current'}>{getNumber(selectIndex + 1)}</Typography>/<Typography
                          className={'page-total'}>{getNumber(highlightList.length)}</Typography>
                      </Box>
                  </HighlightPagination>
              </HighlightContent>
              <HighlightNavBar>
      ...
      <Button onClick={searchApi}>get</Button>
    </HighlightWrap>
  )
}
